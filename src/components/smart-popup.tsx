        ...
        >
          ...
          >
            <button
              ...
              className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-white/70 transition hover:border-white/30 hover:text-white"
            ...
            <h3 className="mt-4 text-2xl font-bold text-white">Need smoother walls on your project?</h3>
            <p className="mt-2 text-sm leading-relaxed text-white/70">
              Speak with a gypsum expert about material supply, application crews, or a complete project
              solution.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              <Link href="/contact#lead-form" onClick={() => setOpen(false)} className="button-modern">
